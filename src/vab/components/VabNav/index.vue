    ...
    <el-row :gutter="15">
      <el-col :lg="12" :md="12" :sm="12" :xl="12" :xs="4">
        <div class="left-panel">
          ...
          <el-tabs v-if="layout === 'comprehensive'" v-model="extra.first" tab-position="top" @tab-click="handleTabClick">
            <template v-for="(route, index) in handleRoutes">
              <el-tab-pane :key="index + route.name" :name="route.name">
                <template #label>
                  <vab-icon v-if="route.meta.icon" :icon="route.meta.icon" :is-custom-svg="route.meta.isCustomSvg" style="min-width: 16px" />

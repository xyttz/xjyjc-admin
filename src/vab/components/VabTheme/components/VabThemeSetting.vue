...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getCode() {
        this.$prompt('请输入秘钥(秘钥请在源码中查看，跳转后需登录购买时绑定的github账号)', '温馨提示', {
          ...
          .then(({ value }) => {
            ...
            switch (_path) {
              ...
              case '/other/menu1/menu1-1/menu1-1-1/menu1-1-1-1':
                path = '/other/nested/menu1/menu1-1/menu1-1-1/menu1-1-1-1/index.vue'
                break
            ...
            window.open(`https://github.com/vue-admin-beautiful/admin-pro/blob/master/src/views${path}`)
          })
          .catch(() => {})
      },
      removeLocalStorage() {

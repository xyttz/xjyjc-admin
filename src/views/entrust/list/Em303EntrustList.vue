  ...
  export default {
    ...
    methods: {
      ...
      checkClick(row) {
        ...
        this.$router.push({
          // path: '/entrust/components/samples/E303',
      ...
      handleReport(row) {
        ...
        // this.$router.push({
        //   path: '/reports/em303/entrust/index',
        //   query: {
        //     entnum: entnum,
        //   },
        // })
        ...
        if (entnum) {
          downloadEntrustReport(entnum, this.pathType).then((response) => {
            this.src = response.data
            this.entrustnum = entnum
            this.reportname = '钢筋原材料拉伸机弯曲性能委托报告'

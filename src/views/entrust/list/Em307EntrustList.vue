  ...
  export default {
    ...
    methods: {
      handleQuery() {
        ...
        list(this.queryParams, '307').then((response) => {
      ...
      checkClick(row) {
        ...
        this.$router.push({
          // path: '/entrust/components/samples/E307',
      ...
      handleReport(row) {
        ...
        // this.$router.push({
        //   path: '/reports/em307/entrust/index',
        //   query: {
        //     entnum: entnum,
        //   },
        // })
        ...
        if (entnum) {
          downloadEntrustReport(entnum, '307').then((response) => {
            this.src = response.data
            this.entrustnum = entnum
            this.reportname = '混凝土外加剂委托报告'

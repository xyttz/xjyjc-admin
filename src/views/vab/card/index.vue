  ...
  <div class="card-container">
    <vab-query-form class="page-header">
      <vab-query-form-top-panel :span="24">
        <el-form ref="form" :inline="true" label-width="50px" :model="queryForm" @submit.native.prevent>
          ...
          <el-form-item label="时间">
            <el-date-picker v-model="queryForm.datetime" placeholder="选择日期时间" type="datetime" />
          </el-form-item>
    ...
    <el-row :gutter="20">
      <el-col v-for="(item, index) in list" :key="index" :lg="8" :md="8" :sm="8" :xl="6" :xs="24">
        <el-card :body-style="{ padding: '0px', position: 'static' }" shadow="hover">
          <vab-magnifier style="width: 100%; height: 228px" type="circle" :url="item.img" :width="150" />

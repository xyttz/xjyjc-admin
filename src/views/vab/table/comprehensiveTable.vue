  ...
  <div class="comprehensive-table-container">
    ...
    <vab-query-form>
      <vab-query-form-top-panel>
        <el-form ref="form" :inline="true" label-width="49px" :model="queryForm" @submit.native.prevent>
      ...
      <vab-query-form-left-panel :span="24">
        ...
        <el-button type="primary" @click="handleMessage">$baseMessage</el-button>
        <el-button type="primary" @click="handleAlert">$baseAlert</el-button>
        <el-button type="primary" @click="handleConfirm">$baseConfirm</el-button>
        <el-button type="primary" @click="handleNotify">$baseNotify</el-button>
        <el-button icon="el-icon-info" type="primary" @click="handleDetailStayTable">停留在本页后台打开详情页后（不常用）</el-button>
        <el-badge class="item" value="New">
          <el-button icon="el-icon-info" style="margin: 0 0 10px 0 !important" type="primary" @click="handleDetail">详情页支持tab多开并高亮左侧菜单</el-button>
        </el-badge>
      </vab-query-form-left-panel>
    </vab-query-form>

    <el-table ref="tableSort" v-loading="listLoading" border :data="list" :height="height" @selection-change="setSelectRows" @sort-change="tableSortChange">
      ...
      <el-table-column align="center" label="点击量" prop="pageViews" show-overflow-tooltip sortable />
      <el-table-column align="center" label="开关" prop="switch" show-overflow-tooltip>
        <template #default="{ row }">
          <el-tooltip :content="row.switch === 0 ? '点击开启' : '点击关闭'" :enterable="false" placement="top">
      ...
      <el-table-column align="center" label="时间" prop="datetime" show-overflow-tooltip width="200" />
      <el-table-column align="center" label="操作" show-overflow-tooltip width="130">
        <template #default="{ row }">
      ...
      handleDetail(row) {
        if (row.id)
          ...
          if (this.selectRows.length === 1) {
            ...
            this.$baseMessage('请选择一行进行详情页跳转', 'error', 'vab-hey-message-error')
          }
        }
      },

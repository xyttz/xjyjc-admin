  ...
  <div class="editor-container">
    <el-form ref="form" label-width="100px" :model="form" :rules="rules">
      ...
      <el-form-item class="vab-quill-content" label="内容" prop="content">
        <vab-quill ref="vab-quill" v-model="form.content" :min-height="400" :options="options" />
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="handleAddImg">模拟在富文本编辑器添加上传到文件服务器的图片url</el-button>
      </el-form-item>
      <el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAddImg() {
        this.form.content += '<img src="https://gitee.com/chu1204505056/image/raw/master/ewm.png" />'
      },
    },
  }
</script>

  ...
  <div class="app-container">
    ...
    <el-form ref="queryForm" :inline="true" :model="queryParams" size="mini">
      ...
      <el-form-item prop="name">
        <el-input v-model="queryParams.name" clearable placeholder="字典项名称" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table ref="table" v-loading="loading" border :data="pageList" @selection-change="handleSelectionChange">
      <el-table-column min-width="5%" type="selection" />
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.visible" width="500px" @close="closeDialog">
      <el-form ref="form" label-width="100px" :model="form" :rules="rules">
        ...
        <el-form-item label="排序" prop="sort">
          <el-input-number v-model="form.sort" controls-position="right" :min="0" style="width: 80px" />
        </el-form-item>

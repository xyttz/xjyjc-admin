      ...
      <el-col :lg="9" :md="12" :sm="24" :xl="9" :xs="24">
        <el-form ref="registerForm" class="register-form" :model="form" :rules="registerRules" size="mini">
          ...
          <el-form-item prop="username">
            <el-input v-model.trim="form.username" v-focus auto-complete="off" :placeholder="translateTitle('请输入用户名')" type="text">
              <template #prefix>
          ...
          <el-form-item prop="phone">
            <el-input v-model.trim="form.phone" maxlength="11" :placeholder="translateTitle('请输入手机号')" show-word-limit type="text">
              <template #prefix>
          ...
          <el-form-item prop="phoneCode" style="position: relative">
            <el-input v-model.trim="form.phoneCode" :placeholder="translateTitle('请输入手机验证码')" type="text">
              <template #prefix>
          ...
          <el-form-item prop="password">
            <el-input v-model.trim="form.password" autocomplete="new-password" :placeholder="translateTitle('请输入密码')" type="password">
              <template #prefix>
      ...
      handleRegister() {
        this.$refs['registerForm'].validate(async (valid) => {
          if (valid) {
            ...
            this.$baseConfirm(`${msg}，点击确定模拟进入拥有【editor】角色的首页`, null, async () => {

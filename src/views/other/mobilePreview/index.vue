<template>
  <div class="mobile-preview-container">
    <el-row class="hidden-xs-only">
      <el-col :lg="12" :md="13" :sm="13" :xl="8" :xs="24">
        <div class="mobile-content">
          <iframe class="mobile-content-iframe" src="https://m.baike.so.com/doc/8246271-8563260.html" />
        </div>
      </el-col>
        ...
        <el-alert :closable="false" type="success">
          <div>
            ...
            <p>
              ...
              <a href="https://www.zhihu.com/question/423592827/answer/1502779880" target="_blank">https://www.zhihu.com/question/423592827/answer/1502779880</a>
            </p>
            <p>
              admin-pro购买链接
              <a href="https://gitee.com/chu1204505056/image/raw/master/zfb_699.jpg" target="_blank">https://gitee.com/chu1204505056/image/raw/master/zfb_699.jpg</a>
    ...
    <el-row class="hidden-sm-and-up">
      <el-col :span="24">
        <el-alert title="手机端支持该组件预览，请切换到PC端查看效果" type="success" />
      </el-col>
    </el-row>
  </div>
</template>

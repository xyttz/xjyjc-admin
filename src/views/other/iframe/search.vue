  ...
  <div class="iframe-search-container">
    <el-row :gutter="20">
      <el-col :lg="{ span: 12, offset: 6 }" :md="{ span: 20, offset: 2 }" :sm="{ span: 20, offset: 2 }" :xl="{ span: 12, offset: 6 }" :xs="24">
        <el-form ref="form" label-position="top" label-width="100px" :model="form" :rules="rules" @submit.native.prevent>
          ...
          <el-button icon="el-icon-search" native-type="submit" type="primary" @click="handleClick">查询</el-button>
        </el-form>
      </el-col>
    </el-row>
  </div>

<template>
  <div class="workflow-container">
    ...
    <!-- 用户节点自定义操作面板 -->
    <AddPanel v-if="showAddPanel" class="add-panel" :lf="lf" :node-data="addClickNode" :style="addPanelStyle" @addNodeFinish="hideAddPanel" />
    <!-- 属性面板 -->
    <el-drawer :before-close="closeDialog" direction="rtl" size="400px" title="设置节点属性" :visible.sync="dialogVisible">
      <PropertyDialog v-if="dialogVisible" :lf="lf" :node-data="clickNode" @setPropertiesFinish="closeDialog" />
    </el-drawer>
    <!-- 数据查看面板 -->
...
<script>
  ...
  import { registerDownload, registerEnd, registerPolyline, registerPush, registerStart, registerUser } from './components/registerNode'

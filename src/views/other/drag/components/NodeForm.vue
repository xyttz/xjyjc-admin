<template>
  <div>
    <el-form v-show="type === 'node'" ref="dataForm" label-width="80px" :model="node">
    ...
    <el-form v-show="type === 'line'" ref="dataForm" label-width="80px" :model="line">
      <el-form-item label="条件">
        <el-input v-model="line.label" />
      </el-form-item>
      <el-form-item>
        <el-button icon="el-icon-close">重置</el-button>
        <el-button icon="el-icon-check" type="primary" @click="saveLine">保存</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 修改连线
      saveLine() {
        this.$emit('set-line-label', this.line.from, this.line.to, this.line.label)
      },
      save() {

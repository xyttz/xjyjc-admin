  ...
  <div ref="tool" class="flow-menu">
    <div v-for="menu in menuList" :key="menu.id">
      ...
      <ul v-show="menu.open" class="vab-node-menu-ul">
        <draggable v-model="menu.children" v-bind="draggableOptions" @end="end" @start="move">
          <li v-for="subMenu in menu.children" :key="subMenu.id" class="vab-node-menu-li" :type="subMenu.type">
            <i :class="subMenu.ico" />
            {{ subMenu.name }}
          </li>
        </draggable>

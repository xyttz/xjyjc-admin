<template>
  <div v-if="easyFlowVisible" style="min-width: 1500px; overflow: hidden">
    ...
    <div style="display: flex; height: calc(100vh - 300px)">
      ...
      <div id="efContainer" ref="efContainer" v-flowDrag class="content" style="overflow: hidden">
      ...
      <div style="padding-top: 20px">
        <node-form ref="nodeForm" @repaintEverything="repaintEverything" @set-line-label="setLineLabel" />
      </div>
    </div>
  </div>
</template>

    ...
    <el-row :gutter="20">
      <el-col :lg="8" :md="12" :sm="24" :xl="8" :xs="24">
        <el-card shadow="hover">
          ...
          <el-button @click="handleMeta('DynamicMeta', { title: 'vab-demo' })">标题变更为 vab-demo</el-button>
          <el-button @click="handleMeta('DynamicMeta', { title: '动态Meta' })">还原为默认标题</el-button>
        </el-card>
      </el-col>
      <el-col :lg="8" :md="12" :sm="24" :xl="8" :xs="24">
        <el-card shadow="hover">
          ...
          <el-button @click="resetBadge('DynamicMeta', { badge: '0' })">徽章清零</el-button>
          <el-button @click="resetBadge('DynamicMeta', { badge: false })">移除徽章</el-button>
        </el-card>
      </el-col>
      <el-col :lg="8" :md="12" :sm="24" :xl="8" :xs="24">
        <el-card shadow="hover">
      ...
      <el-col :lg="8" :md="12" :sm="24" :xl="8" :xs="24">
        <el-card shadow="hover">
          ...
          <el-button @click="handleActiveName('Role')">高亮至角色菜单</el-button>
          <el-button @click="handleActiveName('Notice')">高亮至通知菜单</el-button>
          <el-button @click="handleActiveName('DynamicMeta')">还原默认高亮菜单</el-button>
        </el-card>
      </el-col>
    </el-row>
  </div>

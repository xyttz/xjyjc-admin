...
<script>
  export default {
    ...
    methods: {
      ...
      open6() {
        this.$baseMessage('恭喜你，这是一条成功消息', 'success', 'vab-hey-message-success')
      },
      open7() {
        this.$baseMessage('警告哦，这是一条警告消息', 'warning', 'vab-hey-message-warning')
      },
      open8() {
        this.$baseMessage('错了哦，这是一条错误消息', 'error', 'vab-hey-message-error')
      },
      open9() {
        this.$baseNotify('这是一条消息的提示消息', '提示', 'info', 'bottom-right')
      },
      open10() {
        this.$baseNotify('这是一条成功的提示消息', '成功', 'success', 'bottom-right')
      },
      open11() {
        this.$baseNotify('这是一条警告的提示消息', '警告', 'warning', 'bottom-right')
      },
      open12() {
        this.$baseNotify('这是一条错误的提示消息', '错误', 'error', 'bottom-right')
      },
    },
  }
</script>

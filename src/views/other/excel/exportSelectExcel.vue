    ...
    <vab-query-form>
      <vab-query-form-left-panel>
        <el-form :inline="true" @submit.native.prevent>
          ...
          <el-form-item>
            <el-button type="primary" @click="handleDownload">导出选中行</el-button>
          </el-form-item>
        </el-form>
      </vab-query-form-left-panel>
    </vab-query-form>

    <el-table ref="multipleTable" v-loading="listLoading" border :data="list" @selection-change="handleSelectionChange">

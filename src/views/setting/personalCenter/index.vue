          ...
          <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="账号绑定" name="second">
              ...
              <div class="personal-center-item">
                ...
                <div class="personal-center-item-content">
                  <div>绑定微信</div>
                  <div class="personal-center-item-content-second">当前未绑定绑定微信账号</div>
                </div>
                <el-link type="primary">更换绑定</el-link>
              </div>
              <el-divider />
              <div class="personal-center-item">
                ...
                <div class="personal-center-item-content">
                  <div>绑定支付宝</div>
                  <div class="personal-center-item-content-second">当前未绑定绑定支付宝账号</div>
                </div>
                <el-link type="primary">更换绑定</el-link>
              </div>
              <el-divider />
              <div class="personal-center-item">
                ...
                <div class="personal-center-item-content">
                  <div>绑定微博</div>
                  <div class="personal-center-item-content-second">当前未绑定绑定微博账号</div>
                </div>
                <el-link type="primary">更换绑定</el-link>
              </div>
              <el-divider />
              <div class="personal-center-item">
                ...
                <div class="personal-center-item-content">
                  <div>绑定Github</div>
                  <div class="personal-center-item-content-second">当前未绑定绑定Github账号</div>
                </div>
                <el-link type="primary">更换绑定</el-link>
              </div>
              <el-divider />
              <div class="personal-center-item">
                ...
                <div class="personal-center-item-content">
                  <div>绑定Paypal</div>
                  <div class="personal-center-item-content-second">当前未绑定绑定Paypal账号</div>
                </div>
                <el-link type="primary">更换绑定</el-link>
              </div>
              <el-divider />
    ...
    data() {
      return {
        ...
        form: {
          ...
          nickname: 'good luck',
          sex: 2,
          description: unescape('\u5bcc\u5728\u672f\u6570\uff0c\u4e0d\u5728\u52b3\u8eab\uff1b\u5229\u5728\u52bf\u5c45\uff0c\u4e0d\u5728\u529b\u8015\u3002'),
        },
      }
    },
    computed: {

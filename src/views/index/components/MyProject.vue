<template>
  <el-card shadow="hover">
    ...
    <el-row :gutter="20">
      <el-col v-for="(item, index) in list" :key="index" :lg="12" :md="12" :sm="24" :xl="12" :xs="24">
        <div class="project-card" :style="'background-image:url(' + item.image + ')'" @click="handleOpenWindow(item.url)">
        ...
        list: [
          {
            ...
            description: '一款基于vue2.x + element-ui的绝佳的中后台前端开发管理框架',
            url: 'https://github.com/chuzhixin/vue-admin-beautiful/tree/master',
          },
          {
            image: require('@/assets/index_images/image.jpg'),
            title: 'vue-admin-beautiful(vue3.x)',
            description: '一款基于vue3.x + ant-design-vue的绝佳的中后台前端开发管理框架',

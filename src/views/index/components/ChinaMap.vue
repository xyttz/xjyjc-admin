<template>
  <el-card shadow="hover">
    <template #header>
      ...
      中国地图
      <el-tag class="card-header-tag" type="warning">我爱你中国，亲爱的母亲</el-tag>
    </template>
    <vab-chart :init-options="initOptions" :option="option" style="height: 283px" theme="vab-echarts-theme" />
  </el-card>
</template>

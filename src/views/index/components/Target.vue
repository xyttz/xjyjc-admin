<template>
  <div class="target">
    <el-card class="target-card1" shadow="hover">
      ...
      <vab-chart class="target-echart1" :init-options="initOptions" :option="option" theme="vab-echarts-theme" />
    </el-card>
    <el-card class="target-card2" shadow="hover">
      ...
      <vab-chart class="target-echart2" :init-options="initOptions" :option="option2" theme="vab-echarts-theme" />
    </el-card>
  </div>
</template>
          ...
          series: [
            {
              name: '销售额',
              type: 'line',
              data: [1905, 1020, 3330, 512, 4463, 2214, 3330, 5412, 1205, 820, 5330, 1112],
              symbolSize: 1,
              symbol: 'circle',
              smooth: true,
              yAxisIndex: 0,

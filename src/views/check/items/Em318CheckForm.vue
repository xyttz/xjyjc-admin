  ...
  <div class="app-container">
    <el-form ref="form" :inline="true" label-width="100px" :model="form" size="small">
      <table style="width: 100%">
        <tr>
          <td colspan="11" style="background-color: #2b508a; color: #fff">委托项目-烧结普通砖</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="td_right">承诺天数：</td>
          <td colspan="3"><el-input-number v-model="form.repcondays" controls-position="right" :min="1" placeholder="请输入承诺天数" style="width: 200px" /></td>
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        listDictItemByCode('C_PZ318').then((response) => {
          this.cGradeOptions = response.data
        })

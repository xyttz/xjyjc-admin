  ...
  <div class="app-container">
    <el-form ref="form" :inline="true" label-width="100px" :model="form" size="small">
      <table style="width: 100%">
        <tr>
          <td colspan="11" style="background-color: #2b508a; color: #fff">委托项目-普通混凝土小型空心砌砖</td>
        </tr>
        <tr>
          <td><el-checkbox v-model="checked1" disabled>抗压强度</el-checkbox></td>
          <td><el-checkbox v-model="checked2" disabled>密度试验</el-checkbox></td>
          <!-- <td><el-checkbox v-model="checked3">抗渗性</el-checkbox></td> -->
        ...
        <tr>
          ...
          <td><el-date-picker v-model="form.repcondate" placeholder="选择诺日期" style="width: 200px" type="date" value-format="yyyy-MM-dd" /></td>
        ...
        <tr>
          <td class="td_right">龄期：</td>
          <td colspan="3"><el-input v-model="form.cLq" placeholder="请输入龄期" style="width: 200px" /></td>
          <td class="td_right">使用地区湿度：</td>
          <td>
            <el-select v-model="form.cSd" placeholder="请选择使用地区湿度" style="width: 200px">
              <el-option v-for="item in cSdOptions" :key="item.name" :label="item.name" :value="item.name" />
            </el-select>
          </td>
        ...
        <tr>
          ...
          <td colspan="3"><el-input v-model="form.structpart" placeholder="请输入结构部位" style="width: 200px" /></td>
          ...
          <td colspan="3"><el-input v-model="form.cCd" style="width: 200px" /></td>
        </tr>
        ...
        <tr>
          ...
          <td><el-input v-model="form.mddengji" placeholder="请输入密度等级" style="width: 200px" /></td>
            ...
            <table style="width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="td_center"><el-input v-model="form.chang0" /></td>
                </tr>
                <tr>
                  ...
                  <td class="td_center"><el-input v-model="form.kuan0" /></td>
                </tr>
                <tr>
                  ...
                  <td class="td_center"><el-input v-model="form.gao0" /></td>
                </tr>
                <tr>
                  ...
                  <td class="td_center"><el-input v-model="form.hezai0" /></td>
                </tr>
                <tr>
                  ...
                  <td class="td_center"><el-input v-model="form.qiangdu0" /></td>
                </tr>
                <tr>
                  <td class="td_right">试验结果值</td>
                  <td class="td_right" colspan="3">强度平均值(Mpa)</td>
                  <td><el-input v-model="form.fpingjun" /></td>
                  <td class="td_right" colspan="3">单块强度最小值(Mpa)</td>
                  <td colspan="3"><el-input v-model="form.fmin" /></td>
                </tr>
                <tr>
                  <td class="td_right">技术指标值</td>
                  <td class="td_right" colspan="3">强度平均值(Mpa)≥</td>
                  <td><el-input v-model="form.fpingjuns" /></td>
                  <td class="td_right" colspan="3">单块强度最小值(Mpa)≥</td>
                  <td colspan="3"><el-input v-model="form.fmins" /></td>
                </tr>
                <tr>
                  <td class="td_right">单项评定</td>
                  <td colspan="9"><el-input v-model="form.checkitem1s" /></td>
                </tr>
              </tbody>
            </table>
          </td>
        ...
        <tr>
          <td colspan="11">
            <table style="width: 100%">
              <thead>
                <tr>
                  <th class="th_center" colspan="10">密度试验</th>
                </tr>
                <tr>
                  <th class="th_center">试样编号</th>
                  <th class="th_center" style="width: 18%">长度(mm)</th>
                  <th class="th_center" style="width: 18%">宽度(mm)</th>
                  <th class="th_center" style="width: 18%">高度(mm)</th>
                  <th class="th_center" style="width: 18%">质量(g)</th>
                  <th class="th_center" style="width: 18%">密度(kg/m)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="td_center"><el-link disabled>1</el-link></td>
                  <td class="td_center"><el-input v-model="form.mdc1" /></td>
                  <td class="td_center"><el-input v-model="form.mdk1" /></td>
                  <td class="td_center"><el-input v-model="form.mdg1" /></td>
                  <td class="td_center"><el-input v-model="form.mdzl1" /></td>
                  <td class="td_center"><el-input v-model="form.md1" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>2</el-link></td>
                  <td class="td_center"><el-input v-model="form.mdc2" /></td>
                  <td class="td_center"><el-input v-model="form.mdk2" /></td>
                  <td class="td_center"><el-input v-model="form.mdg2" /></td>
                  <td class="td_center"><el-input v-model="form.mdzl2" /></td>
                  <td class="td_center"><el-input v-model="form.md2" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>3</el-link></td>
                  <td class="td_center"><el-input v-model="form.mdc3" /></td>
                  <td class="td_center"><el-input v-model="form.mdk3" /></td>
                  <td class="td_center"><el-input v-model="form.mdg3" /></td>
                  <td class="td_center"><el-input v-model="form.mdzl3" /></td>
                  <td class="td_center"><el-input v-model="form.md3" /></td>
                </tr>
              </tbody>
              <tr>
                <td class="td_right">密度平均值(kg/m)</td>
                <td><el-input v-model="form.mdpingjun" /></td>
                <td class="td_right">技术指标</td>
                <td><el-input v-model="form.mdpingjuns" /></td>
                <td class="td_right">单项评定</td>
                <td><el-input v-model="form.checkitem2s" /></td>
              </tr>
            </table>
          </td>
        </tr>
        <tr>
          <td colspan="11">
            <table style="width: 100%">
              <tr>
                <th class="th_center" colspan="11">抗渗性</th>
              </tr>
              <tr>
                <td class="td_right">水面下降高度1(</td>
                <td colspan="3"><el-input v-model="form.dropheight1" /></td>
                <td class="td_right">水面下降高度2</td>
                <td colspan="2"><el-input v-model="form.dropheight2" /></td>
                <td class="td_right">水面下降高度3</td>
                <td colspan="3"><el-input v-model="form.dropheight3" /></td>
              </tr>
              <tr>
                <td class="td_right">不合格砌块数(</td>
                <td colspan="3"><el-input v-model="form.wgphgs" /></td>
                <td class="td_right">单项评定</td>
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        listDictItemByCode('C_SD').then((response) => {
          this.cSdOptions = response.data
        })
        const libParas = { libnum: 'KXQK' }

  ...
  <div class="app-container">
    <el-form ref="form" :inline="true" label-width="100px" :model="form" size="small">
      <table style="width: 100%">
        <tr>
          <td colspan="11" style="background-color: #2b508a; color: #fff">委托项目-烧结空心砖和砌块</td>
        </tr>
        <tr>
          <td><el-checkbox v-model="checked1" disabled>抗压强度</el-checkbox></td>
          <td><el-checkbox v-model="checked3">密度试验</el-checkbox></td>
            ...
            <table style="width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><el-input v-model="form.fpingjun" /></td>
                  <td class="td_right">单块强度最小值(Mpa)</td>
                  <td colspan="2"><el-input v-model="form.fmin" /></td>
                  <td class="td_right">变异系数</td>
                  <td colspan="3"><el-input v-model="form.bianyixishu" /></td>
                </tr>
                <tr>
          ...
          <td colspan="11">
            <table style="width: 100%">
              ...
              <tr>
                ...
                <td colspan="2"><el-input v-model="form.midupingjuns" /></td>
                <td class="td_right">单项评定</td>
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        listDictItemByCode('MiDuDengJi').then((response) => {

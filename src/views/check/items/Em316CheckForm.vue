  ...
  <div class="app-container">
    <el-form ref="form" :inline="true" label-width="100px" :model="form" size="small">
      <table style="width: 100%">
        <tr>
          <td colspan="11" style="background-color: #2b508a; color: #fff">委托项目- 烧结多孔砖</td>
        </tr>
        <tr>
          <td><el-checkbox v-model="checked1" disabled>抗压强度</el-checkbox></td>
          <td><el-checkbox v-model="checked2" disabled>尺寸偏差</el-checkbox></td>
        ...
        <tr>
          ...
          <td class="td_right">风化区域：</td>
          <td>
            <el-select v-model="form.cFh" placeholder="请选择风化区域" style="width: 200px">
              <el-option v-for="item in cFhOptions" :key="item.name" :label="item.name" :value="item.name" />
            </el-select>
          </td>
        ...
        <tr>
          ...
          <td><el-date-picker v-model="form.proddate" placeholder="选择生产日期" style="width: 200px" type="date" value-format="yyyy-MM-dd" /></td>
        ...
        <tr>
          <td colspan="11">
            <table style="width: 100%">
              <thead>
                <tr>
                  <th class="th_center" colspan="11">尺寸偏差测试</th>
                </tr>
                <tr>
                  <th class="th_center">试样编号</th>
                  <th class="th_center" style="width: 9%">1</th>
              ...
              <tbody>
                <tr>
                  <td class="td_center"><el-link disabled>长度(mm)</el-link></td>
                  <td class="td_center"><el-input v-model="form.changa1" /></td>
                  <td class="td_center"><el-input v-model="form.changa2" /></td>
                  <td class="td_center"><el-input v-model="form.changa3" /></td>
                  <td class="td_center"><el-input v-model="form.changa4" /></td>
                  <td class="td_center"><el-input v-model="form.changa5" /></td>
                  <td class="td_center"><el-input v-model="form.changa6" /></td>
                  <td class="td_center"><el-input v-model="form.changa7" /></td>
                  <td class="td_center"><el-input v-model="form.changa8" /></td>
                  <td class="td_center"><el-input v-model="form.changa9" /></td>
                  <td class="td_center"><el-input v-model="form.changa10" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>宽度(mm)</el-link></td>
                  <td class="td_center"><el-input v-model="form.kuana1" /></td>
                  <td class="td_center"><el-input v-model="form.kuana2" /></td>
                  <td class="td_center"><el-input v-model="form.kuana3" /></td>
                  <td class="td_center"><el-input v-model="form.kuana4" /></td>
                  <td class="td_center"><el-input v-model="form.kuana5" /></td>
                  <td class="td_center"><el-input v-model="form.kuana6" /></td>
                  <td class="td_center"><el-input v-model="form.kuana7" /></td>
                  <td class="td_center"><el-input v-model="form.kuana8" /></td>
                  <td class="td_center"><el-input v-model="form.kuana9" /></td>
                  <td class="td_center"><el-input v-model="form.kuana10" /></td>
                </tr>
                <tr>
              ...
              <thead>
                <tr>
                  <th class="th_center">试样编号</th>
                  <th class="th_center" style="width: 9%">11</th>
                  <th class="th_center" style="width: 9%">12</th>
                  <th class="th_center" style="width: 9%">13</th>
                  <th class="th_center" style="width: 9%">14</th>
                  <th class="th_center" style="width: 9%">15</th>
                  <th class="th_center" style="width: 9%">16</th>
                  <th class="th_center" style="width: 9%">17</th>
                  <th class="th_center" style="width: 9%">18</th>
                  <th class="th_center" style="width: 9%">19</th>
                  <th class="th_center" style="width: 9%">20</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="td_center"><el-link disabled>长度(mm)</el-link></td>
                  <td class="td_center"><el-input v-model="form.changa11" /></td>
                  <td class="td_center"><el-input v-model="form.changa12" /></td>
                  <td class="td_center"><el-input v-model="form.changa13" /></td>
                  <td class="td_center"><el-input v-model="form.changa14" /></td>
                  <td class="td_center"><el-input v-model="form.changa15" /></td>
                  <td class="td_center"><el-input v-model="form.changa16" /></td>
                  <td class="td_center"><el-input v-model="form.changa17" /></td>
                  <td class="td_center"><el-input v-model="form.changa18" /></td>
                  <td class="td_center"><el-input v-model="form.changa19" /></td>
                  <td class="td_center"><el-input v-model="form.changa20" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>宽度(mm)</el-link></td>
                  <td class="td_center"><el-input v-model="form.kuana11" /></td>
                  <td class="td_center"><el-input v-model="form.kuana12" /></td>
                  <td class="td_center"><el-input v-model="form.kuana13" /></td>
                  <td class="td_center"><el-input v-model="form.kuana14" /></td>
                  <td class="td_center"><el-input v-model="form.kuana15" /></td>
                  <td class="td_center"><el-input v-model="form.kuana16" /></td>
                  <td class="td_center"><el-input v-model="form.kuana17" /></td>
                  <td class="td_center"><el-input v-model="form.kuana18" /></td>
                  <td class="td_center"><el-input v-model="form.kuana19" /></td>
                  <td class="td_center"><el-input v-model="form.kuana20" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>高度(mm)</el-link></td>
                  <td class="td_center"><el-input v-model="form.gao11" /></td>
                  <td class="td_center"><el-input v-model="form.gao12" /></td>
                  <td class="td_center"><el-input v-model="form.gao13" /></td>
                  <td class="td_center"><el-input v-model="form.gao14" /></td>
                  <td class="td_center"><el-input v-model="form.gao15" /></td>
                  <td class="td_center"><el-input v-model="form.gao16" /></td>
                  <td class="td_center"><el-input v-model="form.gao17" /></td>
                  <td class="td_center"><el-input v-model="form.gao18" /></td>
                  <td class="td_center"><el-input v-model="form.gao19" /></td>
                  <td class="td_center"><el-input v-model="form.gao20" /></td>
                </tr>
              </tbody>
              <tr>
                <td class="td_right">试验结果值</td>
                <td class="td_right">样本平均偏差(mm)</td>
                <td class="td_right">长</td>
                <td colspan="2"><el-input v-model="form.JunCHaC" /></td>
                <td class="td_right">宽</td>
                <td colspan="2"><el-input v-model="form.junchak" /></td>
                <td class="td_right">高</td>
                <td colspan="2"><el-input v-model="form.jichag" /></td>
              </tr>
              <tr>
                <td class="td_right">试验结果值</td>
                <td class="td_right">样本极差(mm)</td>
                <td class="td_right">长</td>
                <td colspan="2"><el-input v-model="form.JunCHaC" /></td>
                <td class="td_right">宽</td>
                <td colspan="2"><el-input v-model="form.junchak" /></td>
              ...
              <tr>
                ...
                <td class="td_right">样本平均偏差(mm)</td>
                <td class="td_right">长</td>
                <td colspan="2"><el-input v-model="form.JunCHaC1" /></td>
                <td class="td_right">宽</td>
                <td colspan="2"><el-input v-model="form.junchak1" /></td>
                <td class="td_right">高</td>
                <td colspan="2"><el-input v-model="form.jichag1" /></td>
              </tr>
              <tr>
                <td class="td_right">技术指标值</td>
                <td class="td_right">样本极差(mm)</td>
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        listDictItemByCode('C_FH').then((response) => {
          this.cFhOptions = response.data
        })
        const libParas = { libnum: 'SJDK' }

  ...
  <div class="app-container">
    <el-form ref="form" :inline="true" label-width="100px" :model="form" size="small">
      <table style="width: 100%">
        <tr>
          <td colspan="11" style="background-color: #2b508a; color: #fff">委托项目-混凝土实心砖</td>
        </tr>
        <tr>
          <td><el-checkbox v-model="checked1" disabled>抗压强度</el-checkbox></td>
          <td><el-checkbox v-model="checked3" disabled>外观与偏差</el-checkbox></td>
          <td><el-checkbox v-model="checked7" disabled>密度</el-checkbox></td>
        ...
        <tr>
          ...
          <td colspan="3"><el-date-picker v-model="form.repcondate" placeholder="选择诺日期" type="date" value-format="yyyy-MM-dd" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3">
            <el-select v-model="form.cLq" placeholder="请选择砖品种" style="width: 200px">
              <el-option v-for="item in cPzOptions" :key="item.name" :label="item.name" :value="item.value" />
            </el-select>
          </td>
          ...
          <td colspan="3">
            <el-input v-model="form.structpart" placeholder="请输入结构部位" style="width: 200px" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3">
            <el-input v-model="form.cDj" placeholder="请输入产品等级" style="width: 200px" />
          </td>
          ...
          <td class="td_right">使用部位：</td>
          <td colspan="3"><el-input v-model="form.cBw" placeholder="请输入工程部位" style="width: 200px" /></td>
        </tr>
            ...
            <table style="width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="10"><el-input v-model="form.wgphgs" /></td>
                </tr>
              </tbody>
            </table>
          </td>
            ...
            <table style="width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="td_center" colspan="2"><el-input v-model="form.miduC1" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduK1" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduG1" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduZl1" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduMd1" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>2</el-link></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduC2" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduK2" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduG2" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduZl2" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduMd2" /></td>
                </tr>
                <tr>
                  <td class="td_center"><el-link disabled>3</el-link></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduC3" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduK3" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduG3" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduZl3" /></td>
                  <td class="td_center" colspan="2"><el-input v-model="form.miduMd3" /></td>
                </tr>
              </tbody>
              <tr>
                ...
                <td colspan="6"><el-input v-model="form.mdpingjuns" /></td>
              </tr>
              <tr>

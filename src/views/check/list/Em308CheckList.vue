<template>
  <div class="components-container">
    ...
    <!-- 数据表格 -->
    <el-table ref="table" v-loading="loading" border :data="pageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="样品编号" prop="sampnum" width="160" />
      ...
      <el-table-column align="center" fixed="right" label="操作" width="250">
        <template slot-scope="scope">
          ...
          <el-button v-permissions="['chk:link:pkpmsync']" icon="el-icon-share" plain size="mini" type="primary" @click.stop="handleSync(scope.row)">PKPM▶Cloud</el-button>
...
<script>
  import { list, syncCheckData } from '@/api/entrust/entrust'

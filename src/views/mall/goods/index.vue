          ...
          <div class="goods-card-body">
            ...
            <div class="goods-image-group">
              <div class="goods-image">
                ...
                <el-image v-if="item.image || item.svg" :class="{ isSvg: item.svg }" fit="cover" :src="item.image || item.svg" />
              </div>
            </div>
            ...
            <div class="goods-detail">
              <a :href="item.url + '?hmsr=admin-pro&hmpl=&hmcu=&hmkw=&hmci='" target="_blank">

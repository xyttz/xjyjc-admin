...
function handleRandomImage(/* width = 50, height = 50 */) {
  ...
  return `https://gitee.com/chu1204505056/image/raw/master/table/vab-image-${Random.integer(1, 38)}.jpg`
}
...
function handleMockArray() {
  const getFiles = (path, baseUrl = './controller') => {
    ...
    return files.flatMap((file) => {
      ...
      return stat.isDirectory() ? getFiles(fPath, `${baseUrl}/${file}`) : `${baseUrl}/${file}`
    })
  }
